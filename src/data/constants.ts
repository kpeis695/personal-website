...
using use = useUsing("use")`,
  ...
  [SkillNames.JAVA]: {
    ...
    name: "java",
    label: "Java",
    shortDescription: "Enterprise code with all the beans! ☕️",
    color: "#007396",
  ...
  [SkillNames.KAFKA]: {
    ...
    name: "kafka",
    label: "Apache Kafka",
    shortDescription: "Streaming data like it's Netflix! 📡",
    color: "#231F20",
  ...
  [SkillNames.PYTORCH]: {
    ...
    name: "pytorch",
    label: "PyTorch",
    shortDescription: "Neural networks hitting different! 🧠🔥",
    color: "#EE4C2C",
  ...
  [SkillNames.TENSORFLOW]: {
    ...
    name: "tensorflow",
    label: "TensorFlow",
    shortDescription: "Google's ML framework slaps! 🤖",
    color: "#FF6F00",
  ...
  [SkillNames.FASTAPI]: {
    ...
    name: "fastapi",
    label: "FastAPI",
    shortDescription: "Python APIs go zoom zoom! ⚡️",
    color: "#009688",
  ...
  [SkillNames.SWIFT]: {
    ...
    name: "swift",
    label: "Swift",
    shortDescription: "iOS development hitting different! 🍎",
    color: "#FA7343",
